...
const CreateInputs = () => {
    ...
    let addingCardtoStore = (values, actions) => {
        ...
        dispatch(SendFlashCardtostore(values))
    ...
    return (
        <>
            <Formik
                ...
                // here onSubmit will automatically add on fromik froms when we click Create Card it will add all the value to State of Store...
                onSubmit={addingCardtoStore}
                // here first its validates the input from given by in yup library
                    ...
                    <Form>
                        <div className=' row mx-2   shadow  border border-2 my-2  '>
                            ...
                            <div className='mx-2 my-3'>
                                <div>
                                    <h5 className='text-color font-weight-bolde'>Create Title<span className='m-1  colors'>*</span></h5>
                                </div>
                                <div className='row'>
                                    <div className='col-md-4  '>
                                        <Field type="text" autoComplete="off" name="titlename" placeholder="Add your Title here...." className="form-control shadow-none border border-border-1 background"></Field>
                                    ...
                                    <div className='col-md-3'>
                                        ...
                                        {titleimg ? (
                                            <div className='margin' >
                                                <img className='image-displays' src={titleimg} alt="titleimg"></img>
                                            ...
                                            <div className='mb-2 '>
                                                <Button className='btn' variant="outline-primary" type="button" onClick={() => ImageRef.current.click() }>
                                                    <FontAwesomeIcon className='icon-style' icon={faUpload} ></FontAwesomeIcon>
                                                    <span>Upload Image</span>
                                                    {/* // here "image/* means accept all type of images" */}
                                                    <input type="file" name="" accept="image/*,.pdf,.doc,.docs" ref={ImageRef} style={{ display: "none" }} value={titleimg}
                                                        onChange={(event) => {
                            ...
                            <div className='m-2 my-2'>
                                ...
                                <div className='col-md-7'>
                                    <Field type="text" autoComplete="off" name="titledescription" placeholder="Add your notes here....." className="form-control shadow-none border border-border-1 p-4  background"></Field>
                                        ...
                                        <div >
                                            {Card && Card.length > 0
                                                ? Card.map((Card, index) => (
                                                    <div key={index}>
                                                        <div className=' row mx-2   shadow  border border-2 my-2  '>
                                                            <div className=' col-md-1 d-inline-block  font number bg-danger m-3 fs-3 index'>
                                                                {index + 1} <span className='indexes'>.</span>
                                                            </div>
                                                            <div className='col-md-3 '>
                                                                <div>
                                                                    <h2 className="fs-6 mx-1 my-2 colors"> Add Card Title </h2>  
                                                                </div>
                                                                <div>
                                                                    ...
                                                                    <Field type="text" autoComplete="off" name={`Card.${index}.Cardname`} innerRef={focusref} className="form-control   shadow-none   background  " placeholder="Enter Card's Title..."/>
                                                            ...
                                                            <div className='col-md-4  '>
                                                                <div>
                                                                    <h2 className='fs-6 mx-1 my-2 colors'> Add About </h2>
                                                                </div>
                                                                <div>
                                                                    <Field autoComplete="off" as="textarea" name={`Card.${index}.Carddescription`} className="form-control shadow-none my-2 text-area background" placeholder="Enter Card's Description..."/>
                                                    ...
                                                    if our Card image is present then show a image that user selected here */}
                                                                {Card.Cardimg ? (
                                                                    <div className='margin' >
                                                                        <img className='images-display' src={Card.Cardimg} alt={Card.Cardimg}></img>
                                                                    ...
                                                                    <div className=' my-3 ms-2 '>
                                                                        <input type="file" value={Card.Cardimg} accept="image/*,.pdf,.doc,.docs"
                                                                            onChange={(event) => {
                                                                                const file = event.target.files[0];
                                                                                const reader = new FileReader();
                                                                                reader.readAsDataURL(file)
                                                            ...
                                                            <div className='col-md-1'>
                                                                ...
                                                                {/* //   when user click on {faedit } the focus will go to Cardname input. */}
                                                                    <button type='button'onClick={() => focusref.current.focus()}className="Button">
                                                                ...
                                                                {/* //  {fatrash} is a button when clicked  it removed all the particular index input */}
                                                                    <button type="button" onClick={() => arrayHelper.remove(index)} className="Button" >
                                            ...
                                            <div>
                                                ...
                                                >
                                                    ...
                                                    <span className='colors'> Add More </span> 
                                                </button>
                                            </div>
                                            ...
                                            {Card && Card.length > 0 ? (
                                                <div className='text-center p-4'>
                                                    ...
                                                    <Button variant="danger" type="submit" className='create-button bg-danger' disabled={isSubmitting}> Click to Create </Button>
                                                    <Button onClick={() => { window.location.reload(true); }} type="button" className='mx-3 my-2 refresh-button bg-danger'> Click to Refresh </Button>   
                                                </div>
                                            ) : ( null ) 
                                            }  
                                        </div>
