...
const getDataFromLocalStroage=()=>{
  ...
  const MySlice=createSlice({
    ...
    name:"FlashCard",
    reducers:({
    // it sendFlashCardtoStore is a reducer which will basically push all the value to the Global State of an Application which is Store..
       SendFlashCardtostore: (state,action)=>{
    // console.log(action);
...
// Here SendFlashCardtostore is named export ..its defines the action so its is basically action create that why we use this
export  const {SendFlashCardtostore} =MySlice.actions;
